    ...
    <div className="container-xxl">
      <div className="row text-center align-items-center">
        <div className="col-lg-6 col-md-12 p-3">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3495.0842478816844!2d77.58221447470171!3d28.836351674797253!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390c8aa1fd6a7f25%3A0x30d72f474b492740!2sDr.%20K.N.%20Modi%20Engineering%20College!5e0!3m2!1sen!2sin!4v1692288359778!5m2!1sen!2sin" allowfullscreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
        <div className="col-lg-6 col-md-12">
            <div className="card p-5">
                <h2 className='footer-title mb-3'><b>Contact Us</b></h2>
                  <p className='mb-2'><b>Address:</b>  Dr. K.N. Modi Engineering College</p>
                  <p className='mb-2'><b>Phone:</b>  <a className='footer-tel' href="tel:+1234567890">Call us at +1 (234) 567-890</a></p>
                  <p className='mb-4'><b>Hours:</b>  From 9 a.m To 5 p.m</p>
